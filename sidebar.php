...
<div class="left-sidebar">
	<nav class="sidebar-menu">
		<ul id="nav-accordion">
			<li class="sub-menu">
				<a href="javascript:;" class="<?php if($page_name == 'dashboard.php' || $page_name == 'member_list.php' || $page_name == 'invoice.php' || $page_name == 'add_member.php' || $page_name == 'javascript:void(0);') { ?> active<?php } ?>">
					<i class=" ti-home"></i>
					<span>Manage</span>
				</a>
				<ul class="sub">
					<li class="<?php if($page_name == 'dashboard.php') { ?> active<?php } ?>"><a  href="dashboard.php">Dashboard</a></li>
					<li class="<?php if($page_name == 'member_list.php' || $page_name == 'add_member.php') { ?> active<?php } ?>"><a  href="member_list.php">Members</a></li>
