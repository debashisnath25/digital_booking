                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-fill mb-4" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tab-j_2">BILLING INFO</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tab-j_3">PAYMENTS</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab-j_1" role="tabpanel">
                                        <form>
											...
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-3 col-form-label">Subdomain</label>
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputPassword3" placeholder="Subdomain">
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-3 col-form-label">Time Zone</label>
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputPassword3" placeholder="Password">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-3 col-form-label">Default Language</label>
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputPassword3" placeholder="English">
												</div>
											</div>
											<div class="form-group row">
										...
										<div class="form-group row">
											<label for="inputPassword3" class="col-sm-3 col-form-label">Billing Email Address</label>
											<div class="col-sm-9">
